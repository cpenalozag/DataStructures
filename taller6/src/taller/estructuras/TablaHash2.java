...
public class TablaHash2<K,V> {
	/**
	 * Capacidad inicial de la tabla.
	 */
	private static final int INIT_CAPACITY = 4000039;

	/** 
	 * Enumeración de colisiones que se pueden manejar
	 */
	private enum String{
//		UNO ("Linear probing"),
//		DOS("Separate chaining")
//		;
	}
	...
	/**
	 * Factor de carga máximo de la tabla.
	 */
	...
	public TablaHash2(){
		this(INIT_CAPACITY, INIT_CAPACITY/2000000);
	}
	...
	// resizes the hash table to the given capacity by re-hashing all of the keys
		private void resize(int capacity) {
			TablaHash2<K, V> temp = new TablaHash2<K, V>(capacity, factorCargaMax);
			for (int i = 0; i < m; i++) {
				if (keys[i] != null) {
